import { Chatwoot_Client } from "./chatwoot_client.js";
...
export class BotWrapper {
  ...
  static async init(_bot, _options) {
  ...
  static async SetupBotListeners(PORT) {
    ...
    this.BotInstance.provider.on("message", (message) => {
      this.queueMessage.enqueue(async () => {
        return await this.processMessage(message);
      });
    });

    this.BotInstance.on("send_message", (message) => {
      this.queueMessage.enqueue(async () => {
